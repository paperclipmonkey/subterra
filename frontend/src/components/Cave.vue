      ...
      <v-col cols="12">
        <v-card>
          ...
          <v-card-text>
            ...
            <p><strong>Length:</strong> {{ cave.length }}</p>
            <p><strong>Depth:</strong> {{ cave.depth }}</p>
            <p><strong>Location:</strong> <a :href='googleMapsUrl'>{{ cave.location.name }}</a>, {{ cave.location.country }}</p>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
