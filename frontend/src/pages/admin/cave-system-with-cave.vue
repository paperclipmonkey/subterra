        ...
        <v-col cols="12" md="6">
          <v-card>
            ...
            <v-card-text>
              ...
              <v-text-field v-model="system.vertical_range" label="Vertical Range (m)" type="number"
                required></v-text-field>
              <v-text-field v-model="system.slug" label="Slug" :placeholder="'e.g. region_cave-name'"
                :hint="'Lowercase, a-z, 0-9, _ and - only'" persistent-hint></v-text-field>
        ...
        <v-col cols="12" md="6">
          <v-card>
            ...
            <v-card-text>
              ...
              <v-text-field v-model="cave.slug" label="Slug" :placeholder="'e.g. region_cave-name'"
                :hint="'Lowercase, a-z, 0-9, _ and - only'" persistent-hint></v-text-field>
            </v-card-text>
          </v-card>
        </v-col>
