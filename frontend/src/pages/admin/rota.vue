  ...
  <v-container>
    <v-toolbar flat>
      ...
      <v-btn-toggle v-model="viewMode" mandatory class="mr-4">
        <v-btn value="list" icon><v-icon :icon="mdiViewList" /></v-btn>
        <v-btn value="calendar" icon><v-icon :icon="mdiCalendar" /></v-btn>
      </v-btn-toggle>
    </v-toolbar>
    ...
    <v-row>
      <v-col cols="12" md="4">
        <v-card class="mt-4" outlined>
          <v-card-title>
            <v-icon left :icon="mdiCalendarPlus" /> Add Shift
          </v-card-title>
          <v-card-text>
      ...
      <v-col cols="12" md="8">
        ...
        <v-card v-if="viewMode === 'calendar'" class="mt-4" outlined>
          <v-card-title class="d-flex align-center">
            <v-btn icon small @click="prevMonth"><v-icon :icon="mdiChevronLeft" /></v-btn>
            <span class="mx-4">{{ currentMonthName }}</span>
            <v-btn icon small @click="nextMonth"><v-icon :icon="mdiChevronRight" /></v-btn>
          </v-card-title>
