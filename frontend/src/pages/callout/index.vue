    ...
    <v-container>
        <v-row justify="center">
            <v-col cols="12" md="8">
                ...
                <!-- Callout Stats & Map -->
                <v-card class="mb-6 elevation-2" v-if="activeCallouts.length > 0">
                    ...
                    <v-card-text>
                        <div class="d-flex align-center">
                            <v-avatar color="white" size="48" class="mr-4 elevation-1">
                                <v-img v-if="onCallOfficer && onCallOfficer.photo" :src="onCallOfficer.photo"></v-img>
                            ...
                            <div>
                                ...
                                <div class="text-h6 font-weight-bold" v-if="onCallOfficer">
